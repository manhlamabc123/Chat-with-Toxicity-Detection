...
export default function App() {
  ...
  const model = useRef<any | null>(null); // Retain a value throughout the Component's render cycles WITHOUT triggering a render, as opposed to a useState variable
    ...
    <>
      ...
      {hasLoaded && (
        <form onSubmit={sendMessage}>
          ...
          {toxicity.labels.map((l: any) => ` ${l.label} ${l.prob}`)}
        </form>
      )}
    </>
  );
